    ...
    <div className="mx-auto max-w-7xl px-4 py-8 text-slate-900">
      <div className="mb-8 flex flex-col justify-between gap-4 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm sm:flex-row sm:items-center">
        <div>
          ...
          <h1 className="mt-1 text-2xl font-bold capitalize tracking-tight text-slate-950">
            {jobTitle}
          </h1>
        ...
        <div className="flex flex-col gap-6 lg:col-span-4">
          <div className="relative overflow-hidden rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <p className="mt-4 text-center text-xs text-slate-500">
              ...
              to cross the 70% interview threshold.
            </p>
          </div>
          ...
          <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <p className="mt-3 line-clamp-4 text-xs leading-relaxed text-slate-600">
              {jobDescription}
            </p>
          </div>
          ...
          <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
            ...
            <div className="relative aspect-4/5 overflow-hidden bg-slate-100">
              ...
              <div className="absolute inset-0 flex items-end bg-linear-to-t from-slate-950/60 via-transparent to-transparent p-4">
                <Link
                  to={resumePath}
                  target="_blank"
                  rel="noreferrer"
                  className="flex w-full items-center justify-center gap-2 rounded-xl bg-white/90 py-2.5 text-xs font-medium text-slate-900 shadow-sm backdrop-blur-md hover:bg-white"
                >
        ...
        <div className="flex flex-col gap-6 lg:col-span-8">
          <div className="flex items-center justify-between">
            ...
            <span className="text-xs font-medium text-slate-500">
              {Object.keys(categories).length} Key Area Audits
            </span>
          </div>
                ...
                ([key, data]) =>
                  data.tips
                    ...
                    .map((tip, idx) => (
                      ...
                      >
                        <div className="flex items-center gap-3">
                          <div className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-white text-[10px] font-bold uppercase text-slate-600 shadow-2xs">
                            {key.substring(0, 2)}
                          </div>
